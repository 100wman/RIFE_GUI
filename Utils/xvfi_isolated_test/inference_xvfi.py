...
from inference_template import VideoFrameInterpolation
...
if __name__ == "__main__":
    ...
    for i, imgs in enumerate(img_paths):
        resize = (2000, 1000)  # you can try to disable resize before interpolation, it could occur unexpected error or MLE
