...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_3.setText(_translate("Dialog", "小时休息10分钟"))
        ...
        self.ForceCpuChecker.setText(_translate("Dialog", "不可用功能：有N卡但强制使用CPU？"))
        self.ExpertModeChecker.setToolTip(_translate("Dialog", "<html><head/><body><p><span style=\" font-weight:600;\">显示专业选项</span></p><p>除非你知道这些选项在做什么，否则不要更改这些选项的默认值！！</p></body></html>"))
        ...
        self.DisableDedupRenderChecker.setToolTip(_translate("Dialog", "<html><head/><body><p>压制模式下，不对输入进行额外的内容操作（去重、转场检测等），按照原输入帧率内容压制输出</p></body></html>"))
        ...
        self.QuietModeChecker.setToolTip(_translate("Dialog", "<html><head/><body><p><span style=\" font-weight:600;\">不建议开启</span></p><p>关闭任务启动前的<span style=\" font-weight:600;\">所有提示弹窗</span></p></body></html>"))
