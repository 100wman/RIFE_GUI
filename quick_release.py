...
def generate_release():
    ...
    compile_ols = f'nuitka --standalone --mingw64 --show-memory --show-progress --nofollow-imports                             --windows-icon-from-ico="{ico_path}" --windows-product-name="SVFI CLI" --windows-product-version={ArgumentManager.ols_version} --windows-file-description="SVFI Interpolation CLI"             --windows-company-name="Jeanna-SVFI"  --follow-import-to=Utils,steamworks,model,model_cpu,skvideo  --output-dir=release\{tag_version}                           .\one_line_shot_args.py'
